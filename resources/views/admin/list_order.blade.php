                ...
                <table class="table table-striped table-bordered table-hover" id="dataTables-example">
                    ...
                    <tbody>
                        <?php foreach ($order as $pr): ?>
                            ...
                            <td>{{$pr->khachhang->name}}</td>
                            <td>{{$pr->date}}</td>
                            <td>{{$pr->khachhang->address}}</td>
                            <td>{{$pr->note}}</td>
                            <td>{{$pr->khachhang->phone}}</td>
                            <td>{{$pr->chitietdathang->quantity}}</td>    
                            <td>{{number_format($pr->total)}}</td>
                            {{-- @if($pr->status == 0)
                            <td class="center"></i> <a href="{{route('confirm-order',$pr->id)}}"><img src="source/image/product/xegiaohang.jpg" style="width: 60px;height: 60px" alt=""></a></td>
                            @else
                            <td class="center"></i> <a href="{{route('confirm-order',$pr->id)}}"><img src="source/image/product/delay_car.jpg" style="width: 50px;height: 50px" alt=""></a></td>
                            @endif
                             <td class="center"><a href="{{route('delete-order',$pr->id)}}"><img  src="source/image/product/icon-cancel.png" style="padding-top: 10px;width: 40px;height: 40px "></a></td>
                              <td class="center"><a href="{{route('detail-order',$pr->id)}}"><img  src="source/image/product/icon-hand-right.png" style="padding-top: 10px;width: 40px;height: 40px "></a></td> --}}
                        </tr>
                        <?php endforeach ?>
                    </tbody>
                </table>
